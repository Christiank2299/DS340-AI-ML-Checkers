...
# and the method returns 1. Otherwise, if neither player has lost, the method returns a reward of 0.5, indicating a tie or a draw.
    ...
    def evaluate(self):
        # suboptimal evaluation method used for the minimax and minimax_ab
...
def run():
    ...
    while (game.running):
        ...
        if len(options1) > 0:
            ...
            value, best_move = minimax_ab(board_state, 3 ,float('inf'), float('-inf'), False)
            #value, best_move = minimax(board_state, 3, False)
